...
## Это *удобная* современная технология для общения между сервером и клиентом
...
- Описание связей между ресурсами c фильтрацией <!-- .element: class="fragment" -->
- Выбор полей в ответе из коробки <!-- .element: class="fragment" -->
- Вложенные запросы <!-- .element: class="fragment" -->
- Гибкость агруменентов на любом уровне вложенности <!-- .element: class="fragment" -->
...
GraphQL задает конву, формат того как вы описываете доступ к своим данным.
