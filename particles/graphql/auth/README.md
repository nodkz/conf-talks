...
### 1. Авторизация на уровне сервера (apollo, express, koa и пр.)
...
### 3. Авторизация на уровне полей (в resolve методах)
...
### 4. Авторизация на уровне связей между типами (в resolve методах)
  ...
  fields: () => ({
    ...
    metaList: {
      ...
      resolve: async (source, _, context) => {
        ...
        // проверяем доступ на отображение конкретных мета данных
