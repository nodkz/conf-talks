...
#### статического анализа React-приложения

![Photo](../assets/nodkz-photo.jpg) <!-- .element: style="max-width: 100px;" class="plain"  -->
...
[http://bit.ly/piter-graphql-client](https://nodkz.github.io/conf-talks/talks/2019.05.24-holyjs-piter/index.html) <!-- .element: style="color: #ffffff" -->
