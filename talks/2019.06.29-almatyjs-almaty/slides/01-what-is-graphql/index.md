...
### через нее вы можете узнать о схеме данных на сервере.
...
## Фичи GraphQL: <!-- .element: class="green" -->

- Язык запросов для API (что просите, то получаете) <!-- .element: class="fragment" -->
