...
## Как же приходится жутко изголятся ~~фронтендерам~~ учённым на кривых апи без участия бэкендеров или прямого доступа к БД.

-----

### Мой Conclusion 3  <!-- .element: class="gray" -->

## А ниче так, кстати, зашел GraphQL для анализа связных данных
