<table>
  <tr>
    <td style="vertical-align: middle">
        ...
        <h2>
          <span class="green">ApolloClient, <br/>graphql-codegen</span>
          <br/>и кодогенерация типизированных hook'ов</span>
        </h3>
        <h4><a href="http://bit.ly/graphql-codegen" target="_blank">http://bit.ly/graphql-codegen</a></h4>
        <hr/>
