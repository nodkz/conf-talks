...
#### Если вы его ни разу не пробовали, <br/>и все еще на темплейт литерале gql <br/>– то много потеряли и в докладе вы это увидите. <!-- .element: class="fragment" -->

-----

### В феврале 2020 с Дотаном мы довели его <br/>до состояния relay-compiler

![](./near-operation-file.png) <!-- .element: width="600" class="plain" -->
